<?php
  ...
  function enqueue_custom_styles_and_scripts()
  {
    ...
    wp_enqueue_style('glide-css-styles', plugin_dir_url(__FILE__) . 'css/styles.css', [  ], '0.0.1');
    wp_enqueue_script('glide-js', 'https://cdn.jsdelivr.net/npm/@glidejs/glide', [  ], null, true);
    wp_enqueue_script('glide-init', plugin_dir_url(__FILE__) . 'js/glide-init.js', [ 'glide-js' ], '0.0.1', true);
  }
